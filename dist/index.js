...
var Vlist = /** @class */ (function (_super) {
    ...
    Vlist.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "ant-dropdown-menu", onMouseDown: this.preventDefault },
            React.createElement(VirtualList, { "data$": this.props.data$, "options$": this.options$, style: { height: 400 } }, function (item) { return (React.createElement("div", { style: { height: itemHeight }, className: (_this.props.keyProp ? item[_this.props.keyProp] : item) === _this.props.value
...
var VSelect = /** @class */ (function (_super) {
    ...
    VSelect.prototype.render = function () {
        ...
        return (React.createElement(antd.Dropdown, { overlay: React.createElement(Vlist, { "data$": this.data$, children: this.props.children, keyProp: this.props.keyProp, value: this.state.realValue, itemHeight: this.props.itemHeight, index: this.state.index, onChange: this.onChange }), 
