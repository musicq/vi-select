...
var VirtualList = /** @class */ (function (_super) {
    ...
    VirtualList.prototype.render = function () {
        ...
        return (React.createElement("div", { className: style$1.VirtualList, ref: this.virtualListRef, style: this.props.style },
            React.createElement("div", { className: style$1.VirtualListContainer, style: { height: this.state.scrollHeight } }, this.state.data.map(function (data, i) { return (React.createElement("div", { key: i, className: style$1.VirtualListPlaceholder, style: { top: data.$pos + 'px' } }, data.origin !== undefined ? _this.props.children(data.origin, data.$index) : null)); }))));
    };
