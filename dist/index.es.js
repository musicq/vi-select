...
import { BehaviorSubject, combineLatest, fromEvent, ReplaySubject, Subscription, Subject } from 'rxjs';
import { debounceTime, filter, map, pairwise, skipWhile, startWith, tap, withLatestFrom, delay, throttleTime, distinctUntilChanged } from 'rxjs/operators';
...
var VirtualList = /** @class */ (function (_super) {
    ...
    VirtualList.prototype.render = function () {
        ...
        return (createElement("div", { className: style$1.VirtualList, ref: this.virtualListRef, style: this.props.style },
            createElement("div", { className: style$1.VirtualListContainer, style: { height: this.state.scrollHeight } }, this.state.data.map(function (data, i) { return (createElement("div", { key: i, className: style$1.VirtualListPlaceholder, style: { top: data.$pos + 'px' } }, data.origin !== undefined ? _this.props.children(data.origin, data.$index) : null)); }))));
    };
