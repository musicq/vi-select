...
export class VSelect<T> extends React.Component<IVSelectProps<T>, IVSelectState<T>> {
  ...
  render() {
    ...
    return (
      ...
      >
        <div className={cls} onClick={this.onRefresh} onBlur={this.onRefresh}>
          <div
            ...
            <div className="ant-select-selector">
              ...
              <span className="ant-select-selection-item"
                    style={{
                      display: isShowValuePlaceholder,
                      opacity: this.state.isEdit ? 0.4 : 1,
                    }}>
                {this.state.value}
              </span>
            ...
            {isShowClearBtn && (
              <span className="ant-select-clear" onClick={this.clearValue}>
                <CloseCircleFilled/>
              </span>
            )}
            <span
